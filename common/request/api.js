...
export const getAnnouncement = () => {
	return request(`/api/m2867/63fc09d3d84d2`, 'POST', {
		category_id: 7
	})
}
// 首页 发布
...
//  学习记录 列表
export const autoEnrolllogGetStudyLog = (params) => {
	return request(`/api/m2867/63ff39467c54d`, 'POST', params)
}
//  学习记录 删除	
export const autoEnrolllogDelEnrolllog = (params) => {
	return request(`/api/m2867/6402e1bd51ec0`, 'POST', params)
}
// 课程评论
export const autoCommentGetComment = (params) => {
	return request(`/api/m2867/6402b53388a21`, 'POST', params)
}
// 课程评论 回复

export const autoCommentSetComment = (params) => {
	return request(`/api/m2867/6402c0bfea9ae`, 'POST', params)
}
// 会员记录
export const autoCourseGetCourseLog = (params) => {
	return request(`/api/m2867/640195b196ed9`, 'POST', params)
}
